...
class DB
{
    ...
    protected $db, $dsn, $username, $password;
    private $actionDBType = ActionDBType::NIL;
    private $data;
    private $tableName, $columnNames, $differentIndexColumn;
    private $retSelectData;
    private $selectField, $comparation;
    ...
    public function __construct($dsn, $username, $password, $tableName, $columnNames, $differentIndexColumn)
    {
        ...
        $this->differentIndexColumn = $differentIndexColumn;
    }
    function query()
    {
        // TODO: Implement query() method.
        switch ($this->actionDBType) {

            case ActionDBType::INSERT:
                $this->insert();
                break;
            case ActionDBType::SELECT:
                $this->select();
                break;
            default:
                break;
